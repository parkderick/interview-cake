...
var test = [{ startTime: 0,  endTime: 1 },{ startTime: 3,  endTime: 5 },{ startTime: 4,  endTime: 8 },{ startTime: 10, endTime: 12 },{ startTime: 9,  endTime: 10 }];
// var test = [{ startTime: 1, endTime: 2 }, { startTime: 2, endTime: 3 }]
// var test = [{ startTime: 1, endTime: 5 }, { startTime: 2, endTime: 3 }]
// var test = [{ startTime: 1, endTime: 10 },{ startTime: 2, endTime: 6 },{ startTime: 3, endTime: 5 },{ startTime: 7, endTime: 9 }]
